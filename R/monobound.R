    ...
    if (hasArg(m0.lb)) {
        ...
        if (!audit) {
            ...
            if (sum(violatePos) > 0) {
                ...
                rownames(bdA$m0.lb) <- names(bdA$m0.lb) <-
    ...
    if (hasArg(m1.lb)) {
        ...
        if (!audit) {
            ...
            if (sum(violatePos) > 0) {
                ...
                rownames(bdA$m1.lb) <- names(bdA$m1.lb) <-
    ...
    if (hasArg(mte.lb)) {
        ...
        if (!audit) {
            ...
            if (sum(violatePos) > 0) {
                ...
                rownames(bdA$mte.lb) <- names(bdA$mte.lb) <-
    ...
    if (hasArg(m0.ub)) {
        ...
        if (!audit) {
            ...
            if (sum(violatePos) > 0) {
                ...
                rownames(bdA$m0.ub) <- names(bdA$m0.ub) <-
    ...
    if (hasArg(m1.ub)) {
        ...
        if (!audit) {
            ...
            if (sum(violatePos) > 0) {
                ...
                rownames(bdA$m1.ub) <- names(bdA$m1.ub) <-
    ...
    if(hasArg(mte.ub)) {
        ...
        if (!audit) {
            ...
            if (sum(violatePos) > 0) {
                ...
                rownames(bdA$mte.ub) <- names(bdA$mte.ub) <-
...
genmonoboundA <- function(pm0, pm1, support, grid_index, uvec,
    ...
    if (!is.null(monoA$mono1seq)) {
        ...
        print("there exists a mono1seq")
        print(mono1seq)
        monoA$mono1seq <- NULL
        mono1seq[, 1] <- mono1seq[, 1] + boundLength
        print("hre's the updated mono1seq")
        print(mono1seq)
    }
